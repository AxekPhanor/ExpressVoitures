...
{
    /// <inheritdoc />
    public partial class TableAnnonceVoitureVoitureEnregistre : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoutReparations = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoitureEnregistres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoitureEnregistres_Annonces_Id",
                        column: x => x.Id,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoitureEnregistres_Voitures_Id",
                        column: x => x.Id,
